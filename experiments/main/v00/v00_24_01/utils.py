...
class BackBone(nn.Module):
    def __init__(
        ...
        self.img_encoder = AutoModel.from_pretrained(image_encoder_name)
        img_enc_image_size = 224
        self.resize_for_img_encoder = nn.Upsample(
            size=(img_enc_image_size, img_enc_image_size),
            mode="bilinear",
            align_corners=True,
        )
        encoder_last_channels = 384
